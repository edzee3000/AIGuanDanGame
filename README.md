...
### 主要类和函数介绍： ###
1. 这里一共创建了5个类<br>
![五个类](.\\markdown插入图片\\五个类.png "五个类")<br>
...
（4）玩家类<br>
![玩家类](.\\markdown插入图片\\玩家类.png "玩家类")<br>
...
![搜索玩家的牌空间](.\\markdown插入图片\\搜索玩家的牌空间.png "搜索玩家的牌空间")<br>
...
5. AI起牌阶段的规则<br>
![AI起牌阶段规则](.\\markdown插入图片\\AI起牌阶段规则.png "AI起牌阶段规则")<br>
